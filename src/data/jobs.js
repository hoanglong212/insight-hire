export const jobs = [
  ...
  },
  {
    ...
    job_description: 'Build responsive web applications with an agile team. You will work across the stack, contribute to design decisions, and implement efficient, scalable code with modern frameworks.',
  ...
  },
  {
    ...
    job_description: 'Automate infrastructure and deployment pipelines. You will maintain cloud environments and ensure system reliability, security, and performance across distributed platforms.',
  ...
  },
  {
    ...
    job_description: 'Assist the analytics team in extracting insights from large datasets. You will clean and analyze data, build reports, and present findings to internal stakeholders.',
  ...
  },
  {
    ...
    job_description: 'Support a research project focused on natural language understanding. You will annotate datasets, evaluate model outputs, and help refine NLP workflows.',
  ...
  },
  {
    ...
    job_description: 'Assist in developing and testing computer vision models for real-world applications. You will work on preprocessing, data labeling, and performance evaluation tasks.',
  ...
  },
  {
    ...
    job_description: 'Monitor, analyze, and respond to security incidents. You will secure systems and networks, perform audits, and implement preventive controls against cyber threats.',
  ...
  },
  {
    ...
    job_description: 'Design and implement reinforcement learning algorithms for intelligent decision-making. You will build simulations, train agents, and analyze model behavior under various environments.',
    application_deadline: '2025-04-30',
    posted_date: '2025-03-29',
    company: 'AlphaMotion',
